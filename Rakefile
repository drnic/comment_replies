...
task :dist do
  ...
  Dir.chdir(APP_SRC_DIR) do
    ...
    File.open(File.join(APP_DIST_DIR, APP_BADGE_FILE_NAME), 'w+') do |dist|
  ...
  Dir.chdir(APP_DIST_DIR) do
    ...
    FileUtils.copy_file APP_BADGE_FILE_NAME, "#{APP_BADGE_NAME}-#{APP_VERSION}.js"
  end
  if File.directory?("website")
    ...
    FileUtils.copy_file "dist/#{APP_BADGE_FILE_NAME}", "website/dist/#{APP_BADGE_FILE_NAME}"
    FileUtils.copy_file "dist/#{APP_BADGE_FILE_NAME}", "website/dist/#{APP_BADGE_NAME}-#{APP_VERSION}.js"
  end
end
